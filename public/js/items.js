...
//Jdam WHEN "GENERATE REPORT" BUTTON IS CLICKED FROM THE MODAL
$("#clickToGen").click(function (e) {
  ...
  window.open(
    appRoot + "transactions/report/" + fromDate + "/" + toDate,
    "Print",
    strWindowFeatures
  );
});
...
$("#clickToGenitem").click(function (e) {
  e.preventDefault();
  ...
  var strWindowFeatures = "width=1000,height=500,scrollbars=yes,resizable=yes";
  window.open(
    appRoot + "transactions/itemreport/" + fromDate + "/" + toDate,
    "Print",
    strWindowFeatures
  );
});
...
//Jdam WHEN "GENERATE REPORT" BUTTON IS CLICKED FROM THE MODAL
$("#clickToGenStock").click(function (e) {
  e.preventDefault();
  ...
  window.open(appRoot + "transactions/getItems/", "Print", strWindowFeatures);
});

$("#clickToGenStore").click(function (e) {
  e.preventDefault();
  ...
  window.open(appRoot + "transactions/getStore/", "Print", strWindowFeatures);
});
