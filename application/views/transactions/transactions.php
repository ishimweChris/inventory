            ...
            <div class="row">
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' id='showTransForm'><i class="fa fa-plus"></i> New
                            Transaction </button>
                    </span>
                </div>
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#reportModal'>
                            <i class="fa fa-newspaper-o"></i> Transaction Report
                        </button>
                    </span>
                </div>
                ...
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#itemreportModal'>
                            <i class="fa fa-newspaper-o"></i> Report on New Stock
                        </button>
                    </span>
                </div>
                <div class="col-sm-3">
                        <span class="pointer text-primary">
                            <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#storereportModal'>
                                <i class="fa fa-newspaper-o"></i> Store Summary
                            </button>
                        </span>
                    </div>
                    ...
                    <div class="well">
                        <form name="salesTransForm" id="salesTransForm" role="form">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 form-group-sm">
                                            <input type="text" id="barcodeText" class="form-control"
                                                placeholder="item code" autofocus>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 form-group-sm">
                                            ...
                                            <select class="form-control checkField" id="modeOfPayment">
                                                ...
                                                <option value="Cash and MOMO">Cash and MOMO</option>
                                                <option value="MOMO and POS">MOMO and POS</option>
                                                <option value="CASH MOMO and POS">CASH, MOMO and POS</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <div class="cashAndMomo hidden">
                                                <label for="cashAmount2">Cash</label>
                                                <input type="text" class="form-control" id="cashAmount2">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="cashAndMomo hidden">
                                                <label for="MomoAmount">MOMO</label>
                                                <input type="text" class="form-control" id="MomoAmount">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="MomoAndPos hidden">
                                                <label for="MomoAmount2">MOMO</label>
                                                <input type="text" class="form-control" id="MomoAmount2">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="MomoAndPos hidden">
                                                <label for="posAmount2">POS</label>
                                                <input type="text" class="form-control" id="posAmount2">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="CashAndMomoAndPos  hidden">
                                                <label for="cashAmount3">Cash</label>
                                                <input type="text" class="form-control" id="cashAmount3">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="CashAndMomoAndPos hidden">
                                                <label for="MomoAmount3">MOMO</label>
                                                <input type="text" class="form-control" id="MomoAmount3">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div class="CashAndMomoAndPos hidden">
                                                <label for="posAmount3">POS</label>
                                                <input type="text" class="form-control" id="posAmount3">
                                                <span class="help-block errMsg"></span>
                                            </div>

                                            <div id="amountTenderedDiv">
                                                <label for="amountTendered" id="amountTenderedLabel">Amount
                                                    Tendered</label>
                            ...
                            <div class="row">
                                ...
                                <br class="visible-xs">
                                <div class="col-sm-4 form-group-sm">
                                    <button type="button" class="btn btn-primary btn-sm" id="confirmSaleOrder">Confirm
                                        Order</button>
                                    <button type="button" class="btn btn-danger btn-sm" id="cancelSaleOrder">Clear
                                        Order</button>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        id="hideTransForm">Close</button>
                                </div>
                            </div>
                        </form><!-- end of form-->
                    </div>
...
<!-- jdam this is the part to display date picker for report -->
...
<!-- jdam this is the part to display date picker for item report -->
<div class="modal fade" id='itemreportModal' data-backdrop='static' role='dialog'>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="close" data-dismiss='modal'>&times;</div>
                ...
                <div class="row" id="datePair">
                    <div class="col-sm-6 form-group-sm">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id='transFromItem' class="form-control date start"
                    ...
                    <div class="col-sm-6 form-group-sm">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id='transToItem' class="form-control date end" placeholder="YYYY-MM-DD">
                        </div>
                        <span class="help-block errMsg" id='transToErr'></span>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id='clickToGenitem'>Generate</button>
                <button class="btn btn-danger" data-dismiss='modal'>Close</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id='storereportModal' data-backdrop='static' role='dialog'>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="close" data-dismiss='modal'>&times;</div>
                <h4 class="text-center">Store Report</h4>
            </div>

            <div class="modal-body">
                <div class="row">
                    ' Click Generate the Store Summary report
                </div>
            </div>

            <div class="modal-footer">
                <button class="btn btn-success" id='clickToGenStore'>Generate</button>
                <button class="btn btn-danger" data-dismiss='modal'>Close</button>
            </div>
        </div>
    </div>
