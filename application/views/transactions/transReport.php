        ...
        <div class="container margin-top-5">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rwf <?= number_format($get->totalMoneySpent, 2) ?>
                                        </td>
                                    ...
                                    <?php $sn++; ?>
                                    <?php $total_value += $get->totalPrice; ?>
                                    <?php $total_discount += $get->discount; ?>
                                    <?php $total_vat += $get->vat; ?>
            ...
            <div class="row" style="margin-bottom: 10px">
                ...
                <div class="col-xs-6 text-right">
                    <h4>Total Value: Rwf <?=number_format($total_value, 2)?></h4>
                    <h4>Total Discount: Rwf <?=number_format($total_discount, 2)?></h4>
                    <h4>Total VAT: Rwf <?=number_format($total_vat, 2)?></h4>
                    <h4>Total Earned: Rwf <?=number_format($total_earned, 2)?></h4>
                </div>
            </div>
        </div>
        <!--- panel end-->
