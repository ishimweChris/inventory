                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1><img src="<?=base_url()?>public/images/FBW.png" alt="1410-logo" height="150px"></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color:white">
                            Designed and Developed by <a href="http://www.fashionboutique.rw/" target='_blank' class="text-primary">Coding tech Ltd</a> (2018)
                        </div>
                    </div>
                </div>
            </div>
