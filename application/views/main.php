    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        <img src="<?=base_url()?>public/images/FBW.png" alt="logo" class="img-responsive" width="73px">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Total Earned Today: <b>Rwf <span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a href="http://www.fashionboutique.rw">Coding tech Ltd </a> (2018 - <?=date('Y')?>)
            </p>
        </footer>
