...
<div class="row margin-top-5">
    ...
    <div class="col-sm-3">
        ...
        <section class="panel">
            <center>
                <canvas id="paymentMethodChart" width="200" height="200" /></canvas><br>Payment Methods(%)<span
                    id="paymentMethodYear"></span>
            </center>
        </section>
    </div>
</div>
        ...
        <div class="panel panel-hash">
            ...
            <table class="table table-striped table-responsive table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$get->name?></td>
                        <td>Rwf <?=number_format($get->totEarned, 2)?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
...
<div class="row">
                ...
                <table class="table table-responsive table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$get->qty_sold?></td>
                            <td><?=$get->tot_trans?></td>
                            <td>Rwf <?=number_format($get->tot_earned, 2)?></td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
                </table>
    ...
    <div class="col-sm-6">
        <div class="panel panel-hash">
            <div class="panel-heading">Transactions by Week</div>
            <div class="panel-body scroll panel-height">
...
<div class="col-sm-8">
        <div class="panel panel-hash">
            <div class="panel-heading">Damages
                 <button class="btn damg btn-success" id='printDamage'>Print</button>
                </div>
            <div class="panel-body scroll panel-height">
