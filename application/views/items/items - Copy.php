...
<!--- added by jdam to test date picker    --> 
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="itemPrice" name="itemPrice" placeholder="(Rwf )Unit Price" class="form-control"
...
<!---Jdam End of copy of div to clone when adding more items to sales transaction---->
