                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-2">
                        <span class="pointer text-primary">
                            <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#stockreportModal'>
                                <i class="fa fa-newspaper-o"></i>Stock Report
                            </button>
                        </span>
                    </div>
                </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-4 hidden" id='createNewItemDiv'>
                <div class="well">
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form" action="Image/add_image" method="post"
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="number" id="itemQuantity" name="itemQuantity"
                                    placeholder="Available Quantity" class="form-control" min="0"
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="unitPrice">(Rwf )Unit Price</label>
                                <input type="text" id="itemPrice" name="itemPrice" placeholder="(Rwf )Unit Price"
                                    class="form-control" onchange="checkField(this.value, 'itemPriceErr')">
...
<div id="editItemModal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="items/edit" method="post"
                        enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-4 form-group-sm">
                ...
                <form role="form" action="items/edit_image" method="post"
                        enctype="multipart/form-data">
...
<div class="modal fade" id='stockreportModal' data-backdrop='static' role='dialog'>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    ` Click Generate to view the report on Stock
                </div>
            </div>

            <div class="modal-footer">
                <button class="btn btn-success" id='clickToGenStock'>Generate</button>
