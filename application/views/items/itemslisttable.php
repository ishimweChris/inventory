...
<div class='col-sm-6 text-right'><b>Items Total Worth/Price:</b> Rwf <?=$cum_total ? number_format($cum_total, 2) : '0.00'?></div>
            ...
            <table class="table table-bordered table-striped" style="background-color: #f5f5f5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span id="itemImage-<?=$get->id?>"><img class="thumbnail" style="height: 60px; width: 60px;" src="<?php echo base_url() ?>assets/images/<?php echo $get->item_image ?>"></td>
                        <td>
